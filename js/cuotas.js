...
function renderCuotasTabla(){
  ...
  const filas=lista.map(c=>{
    ...
    const estadoBadge=c.estado==='liquidada'
      ? `<span class="badge badge-green">Liquidada</span>`
      : (venc?`<span class="badge badge-red">Vencida</span>`:`<span class="badge badge-amber">Pendiente</span>`);
